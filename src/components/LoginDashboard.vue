<template>
    <section class="h-screen flex flex-col items-center lg:flex-row justify-evenly">
        <div class="w-screen h-[50vh] flex items-center justify-center lg:w-[50vw] lg:h-screen">
            <img src="../assets/advogado.svg" alt="" class="w-80 md:w-96 lg:w-7/12">
        </div>
        <div class="w-screen h-[60vh] flex items-center justify-center lg:w-[50vw] lg:h-screen">
