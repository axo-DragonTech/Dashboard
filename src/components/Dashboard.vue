<template>
  <div class="bg-[#020225] w-full h-full lg:h-screen flex flex-col items-center">
    <div class="lg:flex-row flex flex-col lg:gap-20 lg:justify-center items-center w-full">
      <!-- Seção Faturamento -->
      <div class="bg-[#02264B] text-white w-1/4 h-2/3 rounded-xl flex justify-center items-center gap-8 mt-12 mr-6">
        <div>
          <h3 class="text-xl">Faturamento</h3>
          <p class="text-4xl">R$1.424,12</p>
          <p><span class="text-green-500 text-xl">▲15%</span> vs. ano anterior</p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-1/12" viewBox="0 0 18 18" fill="none">
      ...
      <div class="bg-[#02264B] text-white w-1/4 h-2/3 rounded-xl flex justify-center items-center gap-8 mt-12 mr-6">
        <div>
          ...
          <p class="text-4xl">1.236</p>
          <p><span class="text-green-500 text-xl">+17%</span> vs. ano anterior</p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-1/12" viewBox="0 0 20 18" fill="none">
      ...
      <div class="mt-24">
        <canvas ref="lawyerChart" class="bg-[#02264B] p-4 px-10"></canvas>
      </div>
    </div>
    <div class="lg:flex-row flex flex-col lg:justify-center lg:gap-20 items-center w-full">
      <!-- Seção Pedidos -->
      <div class="text-white bg-[#02264B] rounded-lg w-2/4 p-4 shadow-lg font-semibold">
